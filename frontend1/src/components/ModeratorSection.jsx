  ...
  return (
    <>
      ...
      <div className="card mt-3">
        <div className="card-header card-header-custom">
          <h4 className="mb-0"><i className="fas fa-clipboard-list"></i> Citizen Reports</h4>
        </div>
        <div className="card-body">
      ...
      <div className="card mt-3">
        <div className="card-header card-header-custom">
          <h4 className="mb-0"><i className="fas fa-info-circle"></i> Politician Details & Progress</h4>
        </div>
      ...
      <div className="card mt-3">
        <div className="card-header card-header-custom">
          <h4 className="mb-0"><i className="fas fa-chart-bar"></i> Contributions Overview</h4>
        </div>
